...
void program_data_type_initiate()
{
	...
	// 													sizeof(int) + sizeof(float) * WEIGHTS_COUNT,	//  _data.seq1
	// 													sizeof(int) + sizeof(float) * WEIGHTS_COUNT + sizeof(char) * SEQ1_MAX_LEN };	//  _data.seq2
	...
	MPI_Datatype 	types[NUM_OF_PARAMS_DATA] = { MPI_INT, MPI_FLOAT, MPI_CHAR, MPI_CHAR };
