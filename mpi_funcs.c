...
void program_data_type_initiate()
{
	...
	int          	blocklengths[NUM_OF_PARAMS_DATA] = { 1, SEQ1_MAX_LEN, SEQ2_MAX_LEN, WEIGHTS_COUNT };
	...
	MPI_Datatype 	types[NUM_OF_PARAMS_DATA] = { MPI_INT, MPI_CHAR, MPI_CHAR, MPI_DOUBLE };
